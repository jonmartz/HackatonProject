...
public class RequestMessageController extends MessageController {
    ...
    public void acceptRequest()
    {
        ...
        AcceptanceMessage acceptanceMessage = new AcceptanceMessage(currentMessage.getReceiver(),
                currentMessage.getSender(), vacation, offeredVacation);
        String offeredVacationID = "";
        if (offeredVacation != null) offeredVacationID = offeredVacation.ID;
        this.database.addMessage(acceptanceMessage.getSender(), acceptanceMessage.getReceiver(), vacation.ID,
                false, acceptanceMessage.getDate(), acceptanceMessage.getTime(),
                acceptanceMessage.getKind(), offeredVacationID);
